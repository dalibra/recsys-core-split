    ...
    if n_users == 0 or n_items == 0:
        ...
        if extended:
            stats.update({
                ...
                "seq_len_max": 0.0,
                "seq_len_median": 0.0,
                "item_occurrence_mean": 0.0,
                "item_occurrence_std": 0.0,
                "item_occurrence_min": 0.0,
                "item_occurrence_max": 0.0,
                "item_occurrence_median": 0.0,
                "user_activity_mean": 0.0,
                "user_activity_std": 0.0,
                "user_activity_min": 0.0,
                "user_activity_max": 0.0,
                "user_activity_median": 0.0,
                "max_timestamp": 0.0,
                "min_timestamp": 0.0,
                "timestamp_range_in_days": 0.0,
                "mean_user_duration": 0.0,
                "median_user_duration": 0.0,
            })
        return stats
